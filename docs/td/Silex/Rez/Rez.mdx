...
The repositories are the back bone of Silex. If you make any changes to the plugins or the [silex_client](../Client/client.md) you can connect to the prod server by ssh using :
